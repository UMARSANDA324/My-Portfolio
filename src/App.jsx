      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10 justify-center">
            ...
            <motion.a
              href="https://wa.me/2349039133907?text=Hello%20Umar,%20I%20want%20to%20work%20with%20you"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-[#25D366] hover:bg-[#1ebd5a] text-white rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 shadow-lg shadow-[#25D366]/25"
            >
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6">
                  <motion.a
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-8 py-4 bg-[#25D366] hover:bg-[#1ebd5a] text-white rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 shadow-lg shadow-[#25D366]/25"
                  >
